...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x12(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,          KC_H,         KC_J,   KC_K,    KC_L,   LT(3,KC_MINS), KC_ENT, 
    KC_CAPS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,          KC_N,         KC_M,   KC_COMM, KC_DOT, KC_UP, LT(4,KC_SLSH), 
    KC_LCTL, KC_LSFT, KC_LGUI, KC_LALT,  LT(3,KC_BSPC), LT(2,KC_SPC), LT(1,KC_SPC), KC_RALT, KC_RCTL,  KC_LEFT, KC_DOWN, KC_RIGHT),
  [1] = LAYOUT_ortho_4x12(
